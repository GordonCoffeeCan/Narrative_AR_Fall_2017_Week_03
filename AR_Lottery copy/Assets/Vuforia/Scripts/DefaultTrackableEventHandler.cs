        ...
        TrackableBehaviour.Status newStatus)
    {
            ...
            newStatus == TrackableBehaviour.Status.EXTENDED_TRACKED)
        {
            ...
            if(mTrackableBehaviour.TrackableName + " found" == "Arcade_1_Screen found") {
                ...
                GameManager.instance.myDialogueTrigger.TriggerDialogue(GameManager.instance.myDialogueTrigger.firstArcade);
            }

            if(mTrackableBehaviour.TrackableName + " found" == "FloorMap found") {
                GameManager.instance.myDialogueTrigger.TriggerDialogue(GameManager.instance.myDialogueTrigger.atFloorMap);
            }
